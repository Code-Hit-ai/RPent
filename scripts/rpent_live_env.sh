...
#
# Override RPENT_CALIBRATION_PATH with the validated calibration for your rig.
export RPENT_ROBOT_CONFIG="${RPENT_ROBOT_CONFIG:-${RPENT_REPO_ROOT}/robots/dual_franka/config/example.yaml}"
export RPENT_CALIBRATION_PATH="${RPENT_CALIBRATION_PATH:-${HOME}/.ros/easy_handeye/hand_eye_calibration.json}"
